       ...
       <div class="row footer-holder">
          ...
          <nav class="col-sm-6 col-lg-4 footer-nav last">
             ...
             <ul class="slide address-block">
                ...
                <li class="wrap-text"><span class="icon-web"></span> <a href="#">{{ trans('travel.website_text') }}</a></li>
    ...
    <div class="footer-bottom">
       <div class="container">
          <div class="row">
             ...
             <div class="col-lg-4">
               <strong class="copyright"><i class="fa fa-polymer"></i>
                    ВЭБ БҮТЭЭСЭН ЦАСТ СОЛЮШН Утас: 88014334
                </strong>
             </div>
          </div>
       </div>
