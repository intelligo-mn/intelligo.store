...
<html>
  <head>
    ...
    <title>MODUN | Documentation</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="/admin" class="logo">
          ...
          <span class="logo-lg"><b>MODUN</b>Admin</span>
        </a>
        ...
        <nav class="navbar navbar-static-top" role="navigation">
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
              <li><a href="http://tortuvshin.github.io">MODUN Website</a></li>
            </ul>
          </div>
        </nav>
      </header>
      <aside class="main-sidebar">
        <div class="sidebar" id="scrollspy">
          ...
          <ul class="nav sidebar-menu">
            ...
            <li><a href="#MODUNeditor"><i class="fa fa-circle-o"></i> MODUNEditor</a></li>
...
<section id="installation">
  <h2 class="page-header" style="padding-top:0"><a href="#installation">Installation</a></h2>
    <p class="lead">
      <H3>Server Requirements</H3>
       Checking to ensure that your web host have the minimum requirements to run MODUN.
     </p>
        <ol>
          <li>PHP &gt;= 5.5.9</li>
  ...
  <hr>
    <h4>Please download "check.php" file and check your web host minimum requirements to run MODUN with below button.</h4>
    <a class="btn btn-primary" href="http://envato.akbilisim.com/public/export/zip/check.zip">Download Check.php file!</a>
  <hr>
    <p class="lead">
    <H3>Installing MODUN</H3>
    The following quick steps show how the installation progress. <br><br>
    </p>
    <h4>Step 1 - Unzip and Upload</h4>
    <p> Extract and copy the files from the archive you have downloaded from CodeCanyon to your server.  <a  target="_blank" href="http://MODUN.akbilisim.com/docsassets/ss/allfiles.png">Make sure you have all files</a> on your server when you have done with upload</p>
  <br>
  ...
  <blockquote>
    <ol>
      <li><a target="_blank" href="http://MODUN.akbilisim.com/docsassets/ss/sswizard1.png">First step</a> checking requirements <br>
        All requirements must be green. If you have red with one of them. Please check <a target="_blank" href="http://MODUN.akbilisim.com/docsassets/ss/sscpanelphp2.png">that page</a> on your cpanel (You can find that options on <a target="_blank" href="http://MODUN.akbilisim.com/docsassets/ss/sscpanelphp1.png" >Select Php Version</a> ). If you did not find any configuration about that. Please contact with your provider.
        <br> <br>
      </li>
      <li><a target="_blank" href="http://MODUN.akbilisim.com/docsassets/ss/sswizard2.png">Next step</a>, Checking your MODUN Access. Please click "GET MODUN Code" button and add your envato purchase code and domain name and take the MODUN access code and check your MODUN access code on that page.
        <br>
        <br>
      </li>
      <li><a target="_blank" href="http://MODUN.akbilisim.com/docsassets/ss/sswizard3.png">On this step</a>, Our installer will check of permissions of directories. If any listed folder is not writable. Please make writable and go to next
        <br>
        <br></li>
      <li><a target="_blank" href="http://MODUN.akbilisim.com/docsassets/ss/sswizard4.png">Final step</a>, you need to type your database details for creating database. <br>
        <br>
        <code>
...
<section id="configuration">
  ...
  <p class="lead">
    When your installation is complete, it’s time to configure MODUN.
    <br><br>
  ...
  <section id="login">
    ...
    <li>See example facebook app details on <a href="/docsassets/ss/sssocialface1.png" target="_blank">SS1</a>,<a href="/docsassets/ss/sssocialface4.png" target="_blank">SS2</a>,  <a href="/docsassets/ss/sssocialface2.png" target="_blank">SS3</a>,  <a href="/docsassets/ss/sssocialface3.png" target="_blank">SS4</a> </li>
      <li>When you have done with all steps you can get access token and secret. Type those to MODUN Admin Panel > Settings > General settings > Login Configuration Facebook app </li>
    </ul>
    <p>

      MODUN Facebook App Callback Url: <code>http://your-site-name.com/auth/social/facebook/callback</code>
    </p>
  ...
  <h4>Twitter</h4>
    <ul>
     ...
     <li>When you have done with all steps you can get access token and secret.  Type those to MODUN Admin Panel > Settings > General settings > Login Configuration Twitter app</li>
    </ul>

    <p>
      MODUN Twitter App Callback Url: <code>http://your-site-name.com/auth/social/twitter/callback</code>
    </p>

  <div class="callout callout-info lead">
    <h4>Reminder!</h4>
    <p>
      If you get error <code>We cant get your email address! Please register with your email address.</code> on your MODUN Twitter logining.<br>
  ...
  <h4>Google</h4>
    <ul>
     ...
     <li>When you have done with all steps you can get Client ID and Client secret.  Type those to MODUN Admin Panel > Settings > General settings > Login Configuration Google app</li>
    </ul>
    <a href="/docsassets/ss/googleappinfo.png" target="_blank">See Full Google App Settings.</A>
    <p>
      MODUN Google App Callback Url: <code>http://your-site-name.com/auth/social/google/callback</code>
    </p>
...
<section id="posts">
  ...
  <p class="lead">
    MODUN comes with 4 post types. News, Lists, Polls and Videos. <br>
...
<section id="MODUNeditor">
    <h2 class="page-header"><a href="#posts">MODUNEditor</a></h2>
    <p class="lead">
      MODUN comes with powerful user post editor. <br>
      With MODUNEditor users can add their news, lists, polls and videos.
...
<section id="users">
  ...
  <p class="lead">
    MODUN owners have full control to users, user information.
  ...
  <ul>
    <li> Username – Usernames must be unique. You can change user username by typing in a new one into the username field and following the instructions that appear.User usernames will display next to any posts user make in the MODUN Script.<br></li>
...
<section id="languages">
  ...
  <h4> Using exiting langauge support of MODUN</h4>
  MODUN has En, Tr, Ru, It, Es support out of box. Just You can use with one quick step
  <ul>
    <li>Open Config Folder > app.php and find  'locale' => 'en' line and type what you have want.</li>
  </ul>
  <h4> Create your langauge support</h4>
  <p class="lead">
    Do you want to use your MODUN in your Languages? With few quick steps you can set up your site with your language.<br>
    You can translate the MODUN into your native language following steps.<br>
  ...
  <br>
      <ul>
        ...
        <li>If you finish translate all available files. You can define your language to MODUN.</li>
  ...
  <ul>
    ...
    <li>See there is <a target="_blank" href="http://MODUN.akbilisim.com/docsassets/ss/ssapplang1.png">language settings</a>.</li>
    <li>You can manage language on there. If you want use only specific languages please make sure you have only you want <a target="_blank" href="http://MODUN.akbilisim.com/docsassets/ss/ssapplang2.png">like this</a></li>
    <li> If you don't want footer multilingual support then remove <a target="_blank" href="http://MODUN.akbilisim.com/docsassets/ss/ssapplang3.png">all language strings on there</a> <br> You will only get default  one(what you select on 'locale' => 'en', ) if you leave empty this.</li>
    <li> Finally
...
<section id="mail">
  ...
  We need mail configuration for registration, password reset system or post approve reminder email for post owner etc. <br>
    ...
    Please open your cpanel and find <a target="_blank" href="http://MODUN.akbilisim.com/docsassets/ss/sscpanelemail1.png">Email accounts</a> option on there<br>
    And  <a target="_blank" href="http://MODUN.akbilisim.com/docsassets/ss/sscpanelemail2.png">create</a> your email address <br>
    Now you have  <a target="_blank" href="http://MODUN.akbilisim.com/docsassets/ss/sscpanelemail3.png">mail address</a>. Please click more button and click Configure Email Settings option.<br>
    In this page you will get  <a target="_blank" href="http://MODUN.akbilisim.com/docsassets/ss/sscpanelemail4.png">this information</a>. Get your mail server info and port there too.<br>

  That's it. Please open your env file on your MODUN main directory. (Please check "I did not find my .env file!" on FAQ tab if you didn't find your env file)
    <br><br>
  Here's the final results must be like this<br>
<code>MAIL_DRIVER=smtp<br>
    MAIL_HOST=mail.MODUN.com<br>
    MAIL_PORT=25<br>
    MAIL_USERNAME=info@MODUN.com<br>
 ...
 You can use Gmail SMTP service too. Use like this;<br>
  ...
  <section id="AWSS3">
    ...
    <p class="lead">
      With MODUN 1.3.1 update allows us to upload posts images and member avatars/splash images to Amazon CDN Storage.<br>
      This is useful for more free space on your server / host.<br>

    <h3>AWS S3 env file setup</h3>
    You can find amazon api keys variables on your .env file in your MODUN root directory. (If you was use MODUN 1.3 so you need to add following variables as manually to env file.)<br>
  ...
  <section id="easyComment">
    ...
    <h3>
      MODUN with easyComment</h3>
    MODUN comes with Facebook Comments and Disqus Comments but also support our comments script called name <a target="_blank" href="http://codecanyon.net/item/easycomment-php-comment-script/12727003">easyComment</a><br><br>

    With easyComment plugin allows you and all MODUN users can write comments for the posts with their MODUN accounts.<br>
    easyComment latest update gives us fully entegre comment system. <br>
    All MODUN users can comment without second registration when you use easyComment.<br>
    ...
    <ul>
      ...
      <li> <code>We suggest you to install on subdomain like comments.yoursite.com. Upload your files to comments subdomain and point your browser to http://comments.yoursite.com/app/install.php.<br>
        ...
        Add your MODUN domain as yoursite.com and www.yoursite.com. Add both to per line</code>
      </li>

      <li> When you done with easyComment side. There's not much to do.</li>
      <li>Just open your MODUN Panel and enter the location where you install easyComment to initiation url field on the MODUN admin panel > plugins > easyComment Plugin Settings. In our example initiation url must be this http://comments.yoursite.com/ </li>
      <li>That's it. Your easyComment works on MODUN script just fine now!</li>
    </ul>
  ...
  <section id="FAQ">
    ...
    <h4>Which Provider Do you recommend for MODUN?</h4>
    <p class="lead">MODUN will work any server if it match with our requiesment. However we suggest <a target="_blank" href="http://www.hawkhost.com">www.hawkhost.com</a>, <a target="_blank" href="http://www.bluehost.com">www.bluehost.com</a>  or <a target="_blank" href="http://www.godaddy.com">www.godaddy.com</a>  hosting for MODUN system. We have many successful installation on one of those </p>
    ...
    <p class="lead">Please install MODUN with fresh files and new database.
    ...
    <p class="lead">It means you do not have PHP 5.5 or newer version. MODUN needs PHP 5.5 / 5.6 or newer version.<br>
     <h5>Upgrade your Php</h5>
    <ul>
      <li>If you using Cpanel so you can find <a target="_blank" href="http://MODUN.akbilisim.com/docsassets/ss/sscpanelphp1.png">Select Php Version</a> option on Php config section<br> <small> If you  don't have  that option on Cpanel then you need to contact with your provider. They disabled that option on your access </small></li>
      <li><a target="_blank" href="http://MODUN.akbilisim.com/docsassets/ss/sscpanelphp3.png">Current PHP version:</a> must be 5.5 or 5.6 or 5.7. All good for MODUN</li>
      <li>And again make sure  your <a target="_blank" href="http://MODUN.akbilisim.com/docsassets/ss/sscpanelphp2.png">extentions must be like this</a>  </li>
    </ul>
    </p>
    ...
    <ul>
      <li>Please first delete all MODUN files and upload check.php (You can get check.php file on <a href="#installation">Installation</a> tab). then point your url to www.yoursite.com/check.php and make sure you have all extensions we need. </li>
      <li>Could be missing files.(Here is the full main folders and files you should get from CodeCanyon <a  target="_blank" href="http://MODUN.akbilisim.com/docsassets/ss/allfiles.png">http://prntscr.com/9caxe3</a>) Make sure you have all.</li>
    ...
    <ul>
      ...
      <li>Than upload installed file to storage folder of MODUN. That's it your site must be show up.</li>
    </ul>
  ...
  <br>
  <br>
  <a class="btn btn-primary" href="http://codecanyon.net/item/MODUN-news-viral-lists-polls-and-videos/13300279?ref=akbilisim">Buy Now!</a>
...
<section id="changelog">
  ...
  - Added: "Save as Draft" Option for MODUNEditor<br>
  - Added: Facebook Post entry for MODUNEditor<br>
  ...
  - Fixed: MODUNeditor link issue<br>
  - Fixed: Other small issues
  <h4>v1.1.1</h4>
  - This update has minor bug-fixes
  <h4>v1.1</h4>
  - Added: <strong>Tweet</strong> Entry, <strong>Instagram</strong> Entry, <strong>SoundCloud </strong>Entry for MODUNEditor<br>
  - Added: Facebook video support for MODUNEditor Video Entry<br>
  ...
  <h4>v1.0.5</h4>
  - Added: <strong>"Get image from the url"</strong> support for MODUNEditor image entry widget.<br>
  - Added: <strong>"Make preview image"</strong> for  MODUNEditor image entry widget.<br>
