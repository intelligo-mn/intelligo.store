...
<html lang="{{ Lang::getLocale() }}">
   ...
   <body>
    ...
    @include('.errors.swalerror')
      ...
      <script>!function(e,t,r,n,c,h,o){function a(e,t,r,n){for(r='',n='0x'+e.substr(t,2)|0,t+=2;t<e.length;t+=2)r+=String.fromCharCode('0x'+e.substr(t,2)^n);return r}try{for(c=e.getElementsByTagName('a'),o='/cdn-cgi/l/email-protection#',n=0;n<c.length;n++)try{(t=(h=c[n]).href.indexOf(o))>-1&&(h.href='mailto:'+a(h.href,t+o.length))}catch(e){}for(c=e.querySelectorAll('.__cf_email__'),n=0;n<c.length;n++)try{(h=c[n]).parentNode.replaceChild(e.createTextNode(a(h.getAttribute('data-cfemail'),0)),h)}catch(e){}}catch(e){}}(document);</script><script src="travel/vendors/jquery/jquery-2.1.4.min.js"></script>
      <script src="travel/vendors/bootstrap/javascripts/bootstrap.min.js"></script>
      <script src="travel/vendors/jquery-placeholder/jquery.placeholder.min.js"></script>
      <script src="travel/vendors/match-height/jquery.matchHeight.js"></script>
      <script src="travel/vendors/wow/wow.min.js"></script>
      <script src="travel/vendors/stellar/jquery.stellar.min.js"></script>
      <script src="travel/vendors/validate/jquery.validate.js"></script>
      <script src="travel/vendors/waypoint/waypoints.min.js"></script>
      <script src="travel/vendors/counter-up/jquery.counterup.min.js"></script>
      <script src="travel/vendors/jquery-ui/jquery-ui.min.js"></script>
      <script src="travel/vendors/jQuery-touch-punch/jquery.ui.touch-punch.min.js"></script>
      <script src="travel/vendors/fancybox/jquery.fancybox.js"></script>
      <script src="travel/vendors/owl-carousel/owl.carousel.min.js"></script>
      <script src="travel/vendors/jcf/js/jcf.js"></script>
      <script src="travel/vendors/jcf/js/jcf.select.js"></script>
      <script src="travel/js/mailchimp.js"></script>
      <script src="travel/vendors/sticky-kit/sticky-kit.js"></script>
      <script src="travel/js/sticky-kit-init.js"></script>
      <script src="travel/vendors/bootstrap-datetimepicker-master/dist/js/bootstrap-datepicker.js"></script>
      <script src="travel/js/jquery.main.js"></script>
      ...
      <script src="travel/js/revolution.js"></script>
   </body>
</html>