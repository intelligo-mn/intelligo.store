...
import { ProductAttributes } from "apps/storefront/components/product/product-attributes";
...
import { useProductQuery } from "apps/storefront/framework/rest/products/products.query";
