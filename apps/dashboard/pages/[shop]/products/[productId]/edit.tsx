import CreateOrUpdateProductForm from "apps/dashboard/components/product/product-form";
...
import { useProductQuery } from "apps/dashboard/data/product/product.query";
