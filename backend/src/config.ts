...
export class Config {
  ...
  'eureka.client.service-url.defaultZone' = 'http://admin:${intelligo.registry.password}@localhost:8761/eureka/';
  'cloud.config.uri' = 'http://admin:${intelligo.registry.password}@localhost:8761/config';
