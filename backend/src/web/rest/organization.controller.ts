...
export class OrganizationController {
  ...
  async post(@Req() req: Request, @Body() organizationDTO: OrganizationDTO): Promise<OrganizationDTO> {
  ...
  async put(@Req() req: Request, @Body() organizationDTO: OrganizationDTO): Promise<OrganizationDTO> {
    HeaderUtil.addEntityCreatedHeaders(req.res, 'Organization', organizationDTO.id);
