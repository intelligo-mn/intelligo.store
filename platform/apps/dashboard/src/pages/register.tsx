...
import RegistrationForm from "@intelligo/dashboard/components/auth/registration-form";
import { useRouter } from "next/router";
import { getAuthCredentials, isAuthenticated } from "@intelligo/dashboard/utils/auth-utils";
