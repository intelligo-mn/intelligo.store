import ForgotPasswordForm from "@intelligo/dashboard/components/auth/forget-password/forget-password";
import Logo from "@intelligo/dashboard/components/ui/logo";
import { SUPER_ADMIN } from "@intelligo/dashboard/utils/constants";
import { parseContextCookie } from "@intelligo/dashboard/utils/parse-cookie";
