...
import { Tax } from "apps/dashboard/src/ts-types/generated";
import { useCreateTaxClassMutation } from "apps/dashboard/src/data/tax/use-tax-create.mutation";
import { useUpdateTaxClassMutation } from "apps/dashboard/src/data/tax/use-tax-update.mutation";
