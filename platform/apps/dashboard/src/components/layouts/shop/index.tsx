...
import Navbar from "@intelligo/dashboard/components/layouts/navigation/top-navbar";
import { getAuthCredentials, hasAccess } from "@intelligo/dashboard/utils/auth-utils";
import SidebarItem from "@intelligo/dashboard/components/layouts/navigation/sidebar-item";
import { siteSettings } from "@intelligo/dashboard/settings/site.settings";
import { useTranslation } from "next-i18next";
import MobileNavigation from "@intelligo/dashboard/components/layouts/navigation/mobile-navigation";
