...
import { ShippingInput, ShippingType, Shipping } from "apps/dashboard/src/ts-types/generated";
import { useCreateShippingClassMutation } from "apps/dashboard/src/data/shipping/use-shipping-create.mutation";
import { useUpdateShippingClassMutation } from "apps/dashboard/src/data/shipping/use-shipping-update.mutation";
