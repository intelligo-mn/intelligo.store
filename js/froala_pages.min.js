...
! function(t, e) {
  ...
  var s = function(t, e) {
      ...
      l = function() {
          ...
          return t.createElement = function(t) {
              ...
              if (e) {
                  ...
                  return i += parseInt(n.marginTop, 10) + parseInt(n.marginBottom, 10)
              }
              return i
              ...
              if (e) {
                  var n = getComputedStyle(t);
                  return i += parseInt(n.marginLeft, 10) + parseInt(n.marginRight, 10)
              }
              return 0
              ...
              e.pageToolbar.el.querySelectorAll(".fp-download-btn").forEach(function(t) {
                  e.opts.showDownloadCounter && t && (t.querySelector("span").innerText = "Downloads (" + i + ")")
              })
          }, t.setDownloadBtnsStatus = function(t, e, i) {
              t.pageToolbar.el.querySelectorAll(".fp-download-btn").forEach(function(t) {
                  t && (t.style.display = i ? "none" : "flex", e ? t.setAttribute("disabled", "disabled") : t.removeAttribute("disabled"))
              })
          }, t
      }(),
      t = function t(e) {
      ...
      a = function(t) {
          ...
          return n(i, t), i.prototype.init = function(t) {
              var e = this;
              this.designBlock = t, this.id = ++i.ID, this.el = l.createElement(t.render({
                  imagesDir: this.opts.designsImagesDir
              })), this.el.setAttribute("data-block-type", l.underscores(t.blockType)), this.el.setAttribute("data-id", this.id), this.events.on(this.el, "mouseenter", function() {
  ...
  c.BLOCKS = {}, c.HEADER = "Headers", c.FOOTER = "Footers", c.Register = function(t, e, i) {
      c.BLOCKS[t] || (c.BLOCKS[t] = []), c.BLOCKS[t].push({
          template: e,
          image: i
      })
  };
  var p = 1,
      ...
      f = function(t) {
          ...
          return n(i, t), i.prototype.init = function(t) {
              var e = this;
              if (this.props = i._[t], !this.props) throw new Error("A button with the name " + t + " could not be found");
  ...
  f.Register = function(t, e) {
      ...
      callback: function() {
          ...
          window.a = e, window.b = t.el, e && l.before(e, t.el), this.page.activeView === r && l.scrollTo(t.el), this.page.blockToolbar.hide(), this.page.blockToolbar.refreshPosition()
      },
      refresh: function() {
          if (this.page.activeBlock) {
              this.el.classList.toggle("fp-hidden", 0 <= [c.HEADER, c.FOOTER].indexOf(this.page.activeBlock.designBlock.blockType));
      ...
      callback: function() {
          if (this.page.activeBlock && confirm("Are you sure you want to remove this design block?")) {
              ...
              this.page.blockToolbar.hide(), l.remove(t.el), this.page.refreshBlocks()
          }
      },
      afterBuild: function() {
      ...
      callback: function() {
          this.page.setView(r), this.page.designsPanel.hide(), this.page.editor.enable()
      },
      refresh: function() {
      ...
      callback: function() {
          var t = !pages.iframeBody.querySelector("[data-block-type]"),
              e = pages.pageToolbar.el.querySelector(".fp-download-btn");
          t ? e.setAttribute("disabled", "disabled") : pages.getHTML().then(function(t) {
              var e = new Blob([t], {
                      type: "text/html"
                  }),
                  i = window.URL.createObjectURL(e),
                  n = document.createElement("a");
              n.href = i, n.download = "froala_design_blocks_website.html", n.click()
          }, function(t) {
              console.log(t)
          })
      }
      ...
      callback: function() {
          this.page.screenSize = i, this.page.iframe.style.width = i + "px", this.page.el.classList.add("fp-view-small"), this.page.refreshIframeSize()
      },
      refresh: function() {
      ...
      callback: function() {
          this.page.screenSize = d, this.page.iframe.style.width = d + "px", this.page.el.classList.add("fp-view-small"), this.page.refreshIframeSize()
      },
      refresh: function() {
  ...
  var u = function(t) {
          ...
          return n(e, t), e.prototype.init = function() {
              this.el = this.doc.createElement("DIV"), this.el.classList.add("fp-block-toolbar"), l.append(this.page.body, this.el), this._addButtons(), this._initEvents()
              ...
              i && i.classList.remove("fp-active"), t.el.classList.add("fp-active"), this.show(e.left, e.top)
          }, e.prototype.show = function(t, e) {
              this.el.classList.add("fp-visible"), this.el.style.left = t + l.offset(this.page.iframe).left + "px", this.el.style.top = Math.max(0, e) / (this.page.activeView === p ? 4 : 1) + l.offset(this.page.iframe).top + "px", this.events.emit("button.refresh")
      ...
      v = "FE2bnB-7A24yC-21uakG3B2kI1zzqsoE5A1G4J4C10B10A7hievkH1C10C3C3B2D4F3C3I-8bA-21fdxD-11A-9F3G2wukvvnhxI4I1tdzwE4djnogD5hiczjbG2A7C5uA2B-9eA-7C-7E3B3tijosD1A20A21srqB5nF-10ejj1lA11lE-13C-11D1cursdC3ihrD-8tpxB8A8qwA-9icD1B8ykohdh1hH3C6C7clA2C4G4haB11xsqqmB1E4I4EBCC1smqB-7D3hhmf1bpfzF-7B-22D6A2vvtB-7A26J-7C-21A-16kfplqkbA2C9B6OMG2F1D1I1C8uD-17e1dywnJ4B3xwsE-11uD4fnlwB5voA-9mE2H3C3A2C-13vF3G3A2frfrscA4B1EypC-22ptF6F1WmhlebfzooG3naC-21iE4D-11uD2aA-62rA3c1htA-9qC-7A2Pc1efwG4F4RA-65lB8bxA4bjwpI-7C-21mA3tnF2ioiC-21uE-13lioeG4eC10jnkldxiA3A5D9qA3C3C1pI-8j1A8==",
      m = function() {
          ...
          return document.cookie = n + "=;expires=Thu, 01 Jan 1970 00:00:01 GMT;domain=" + e + ";", (e || "").replace(/(^\.*)|(\.*$)/g, "")
      }(),
      y = function(t) {
          function e() {
              return s(this, e), o(this, t.apply(this, arguments))
          ...
          return n(e, t), e.prototype.init = function() {
              var t = this,
                  ...
                  n = t._decrypt(t._foo("ziRA1E3B9pA5B-11D-11xg1A3ZB5D1D4B-11ED2EG2pdeoC1clIH4wB-22yQD5uF4YE3E3A9=="));
              i.ul = !0;
              var o = !1,
                  s = 0;
              if (e) {
              ...
              i.makeRequest(t, "POST", function(t) {
                  ...
                  e.available_quantity <= 0 && (e.available_quantity = 0, window.open("https://www.froala.com/pages/pricing"));
              ...
              var i = this._decrypt(this._foo(t)),
                  n = l.createElement(i);
              e = e || "", n && (n.setAttribute("class", "fp-license-error " + e), l.prepend(this.page.body, n), l.setDownloadBtnsStatus(this.page, !0, !0))
          }, e.prototype._decrypt = function(t) {
              if (!t) return t;
              for (var e = "", i = this._foo("charCodeAt"), n = this._foo("fromCharCode"), o = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789".indexOf(t[0]), s = 1; s < t.length - 2; s++) {
                  for (var r = this._sumDigits(++o), a = t[i](s), l = "";
                      /[0-9-]/.test(t[s + 1]);) l += t[++s];
                  l = parseInt(l, 10) || 0, a = this._fromRange(a, r, l), a ^= o - 1 & 31, e += String[n](a)
              }
              return e
          }, e.prototype._isAllowedSubdomain = function(t) {
              for (var e = [this._decrypt("9qqG-7amjlwq==")], i = 0; i < e.length; i++)
                  if (String.prototype.endsWith || (String.prototype.endsWith = function(t, e) {
                          return (void 0 === e || e > this.length) && (e = this.length), this.substring(e - t.length, e) === t
                      }), t.endsWith(e[i])) return !0;
              return !1
          }, e.prototype._parse = function(t) {
              var e = (this._decrypt(t) || "").split("|");
              return 4 === e.length && "PagesV1" === e[0] ? [e[1], e[3], e[2]] : [null, null, ""]
          }, e.prototype._isExpired = function(t) {
              return null === t || new Date(t) < new Date(this._decrypt("rA1E1F1C4B8C7B5E1E5C4=="))
          }, e.prototype._sumDigits = function(t) {
              for (var e = t.toString(), i = 0, n = 0; n < e.length; n++) i += parseInt(e.charAt(n), 10);
              return 10 < i ? i % 9 + 1 : i
              ...
              l.setDownloadBtnsStatus(s, !0), o.makeRequest(i, "POST", function(t, e, i) {
                  var n = t && JSON.parse(t);
                  if (n && n.hasOwnProperty("available_quantity"))
                      
                          o.makeRequest(r, "POST", function() {
                              s.editor.disable();
                              var t = "<!DOCTYPE html>\n                <html>\n                <head>\n                " + s._getHeadHTML() + "\n                </head>\n                <body>\n                " + s._getBodyHTML() + "\n                </body>\n                </html>\n                ";
                              s.editor.enable(), n.available_quantity -= 1, e(t), l.setDownloadCount(s, n.available_quantity), l.setDownloadBtnsStatus(s, !1)
                          }, e, i)
                      
              }, t, e)
          }, e.prototype.makeRequest = function(t, e, i, n, o) {
              var s = this,
                  r = new XMLHttpRequest,
                  a = "POST" === e ? JSON.stringify({
                      key: s.opts.key
                  }) : {};
              r.onreadystatechange = function() {
                  4 === r.readyState && (s._remove(), 200 === r.status ? i && i(r.responseText, n, o) : r.responseText && (s._add("MD5igyH3bfjxpD5A2bD2suxxfC6D6F2C1C1G1A1qnlD-11bA2G3F1A1C1D3C5D3cH-9fJ-7cqvtE6C1A-8I-8lomwwaE1F4smqC-16D6maghB-7I3qvzaseC1B3D3zD2njfldA2A32tdbcagmC2J3B5B-21wD4D6E5clB2uxtvhD5D1G1XYFB2vfG-10qF3cmjeymygi1I-7C8B4C-13B-11B-11sD3zxypA-13oqjneB1A10C7E1F1G3C1D1C1D2hdC-13F-11G-10pkD3H2wzxB-11rA4A-7ssjB4shxfG1A28A5B8xqE4A4A3yoH-7wtfB4B2JtH-8ywqA2E7NqreujjjbD5pmgI-7C8D-17E-13aawG1D2CxpwdA-9G2ytriD-16B-13tD5qvtuiuB-13A4kD-8G3B-7F-7C-21d1D-13f1gTsdxyuA-13A2C-9rsA30A9c1D2D1C4aoqA11=="), o && o(r.responseText)))
              }, r.onerror = function() {
      ...
      k = function(t) {
          ...
          return n(e, t), e.prototype.render = function() {
              ...
              var t = function(t) {
                  if (Object.prototype.hasOwnProperty.call(c.BLOCKS, t)) {
                      ...
                      e.setAttribute("data-block-type", l.underscores(t)), e.innerHTML = t, l.append(n, e), i.events.on(e, "click", function() {
              ...
              t.classList.add("fp-panel-panel"), this.panel = t, l.append(this.body, t)
          }, e.prototype._refreshFilters = function(t) {
              var e = this.panel.querySelector(".fp-panel-blocks-wrapper.fp-visible");
              e && (e.classList.remove("fp-visible"), this.filter.querySelector("a.fp-active").classList.remove("fp-active")), this.filter.querySelector('a[data-block-type="' + l.underscores(t) + '"]').classList.add("fp-active")
          }, e.prototype._refreshDesigns = function(t) {
              var e = void 0;
              if (this.loadedDesigns[l.underscores(t)]) e = this.panel.querySelector('div.fp-panel-blocks-wrapper[data-block-type="' + l.underscores(t) + '"]');
              else {
                  (e = document.createElement("DIV")).setAttribute("data-block-type", l.underscores(t)), e.classList.add("fp-panel-blocks-wrapper"), l.append(this.panel, e);
          ...
          return n(e, t), e.prototype.init = function(t, e) {
              this.el = this.doc.createElement("DIV"), this.el.setAttribute("class", "fp-panel"), this._addTitle(t), this._addContent(e), l.append(this.page.container, this.el), this.render()
          }, e.prototype._addContent = function(t) {
              var e = this.doc.createElement("DIV");
              e.setAttribute("class", "fp-panel-body"), t && (e.innerHTML = t), l.append(this.el, e), this.body = e
      ...
      w = function(t) {
          ...
          return n(e, t), e.prototype.init = function() {}, e.prototype._preventTypingInLinks = function(e) {
              e.events.on("keydown", function(t) {
                  return !e.link.get() || (t.preventDefault(), !1)
              }, !0)
          }, e.prototype.enable = function() {
              var e = this;
              this.FroalaEditor = this.page.iframeDoc.defaultView.FroalaEditor, this._defineLinkButtons();
              var i = this;
              this.page.iframeBody.querySelectorAll("[data-block-type]").forEach(function(t) {
                  t.querySelectorAll('[class*="col"]').forEach(function(t) {
                      t.querySelector(".nav-link") || (e.froalaEditor = new e.FroalaEditor('[class*="col"]', Object.assign(e.opts.editorOptions, {
                          toolbarInline: !0,
                  ...
                  }), t.querySelectorAll("header .nav-link, header nav a.btn").forEach(function(t) {
                      e.froalaEditor = new e.FroalaEditor("header .nav-link, header nav a.btn", Object.assign(e.opts.editorOptions, {
                  ...
                  }), t.querySelectorAll("footer .nav-link, header nav a.btn").forEach(function(t) {
                      e.froalaEditor = new e.FroalaEditor("footer .nav-link, header nav a.btn", Object.assign(e.opts.editorOptions, {
              ...
              this.page.iframeBody.querySelectorAll("[data-block-type]").forEach(function(t) {
                  t.querySelectorAll('[class*="col"]').forEach(function(t) {
                      e.froalaEditor && e.froalaEditor.forEach(function(t) {
                          t && !t.destrying && t.destroy()
                      })
                  }), t.querySelectorAll("footer .nav-link, header .nav-link, header nav a.btn").forEach(function(t) {
                      t.contentEditable = !1
                  })
              })
              ...
              this.FroalaEditor.DefineIcon("linkDestroy", {
                  ...
                  callback: function(t, e) {
                      var i = this.link.get();
                      "link" === e ? (i.classList.add("nav-link"), i.classList.remove("btn", "btn-primary", "btn-outline-primary")) : "button" === e ? (i.classList.remove("nav-link", "btn-outline-primary"), i.classList.add("btn", "btn-primary")) : "outline" === e && (i.classList.remove("nav-link", "btn-primary"), i.classList.add("btn", "btn-outline-primary"))
                  }
              })
          }, e
      }(t),
      B = function(t) {
          ...
          return n(e, t), e.prototype.init = function(t) {
              ...
              i.classList.add("fp-no-block", "fp-no-" + this.name.toLowerCase()), i.setAttribute("data-fp", "true"), i.innerHTML = this.template, this.el = i, this.events.on(i, "click", function() {
                  return e.click()
  ...
  var A = function() {
          ...
          return t.prototype._id = function(t) {
              ...
              t.split(" ").forEach(function(e) {
                  var t = n._id(i);
                  n.domEvents[t] && n.domEvents[t][e] && n.domEvents[t][e].forEach(function(t) {
              ...
              var i = this;
              t.split(" ").forEach(function(t) {
                  i.internalEvents[t] || (i.internalEvents[t] = []), i.internalEvents[t].push(e)
              })
          ...
          return n(e, t), e.prototype.init = function() {
              ...
              o.classList.add("fp-btn-zone"), e && o.setAttribute("id", e), t.forEach(function(t) {
                  if (Array.isArray(t)) {
                      ...
                      i.classList.add("fp-btn-group"), t.forEach(function(t) {
      ...
      D = function() {
          ...
          return i.prototype.render = function() {
              ...
              this.activeView = r, this.pageToolbar = new E(this), this.selector === this.body || this.selector.style.height || (this.selector.style.height = "100%"), this.container.style.height = "calc(100% - " + this.pageToolbar.el.getBoundingClientRect().height + "px)", this.data = new y(this)
          }, i.prototype._buildStylesheets = function() {
              return this.opts.designStylesheets.map(function(t) {
                  return '<link rel="stylesheet" href="' + t + '" />'
              }).join("")
          }, i.prototype._buildJavascripts = function() {
              return this.opts.designJavascripts.map(function(t) {
                  return '<script src="' + t + '"><\/script>'
              }).join("")
          }, i.prototype._initIframe = function() {
              var t = document.createElement("IFRAME");
              (this.iframe = t).setAttribute("src", "about:blank"), t.setAttribute("id", "froala-pages"), l.append(this.el, t), this.iframeDoc = t.contentWindow.document, this.iframeDoc.open(), this.iframeDoc.write("<!DOCTYPE html>"), this.iframeDoc.write('<html>\n                            <head>\n                              <meta name="viewport" content="width=device-width, initial-scale=1">\n                              ' + this._buildStylesheets() + "\n\n                              <style data-fp>" + this.opts.appStyle + "</style>\n                            </head>\n                            <body>\n                              " + this._buildJavascripts() + "\n                            </body>\n                          </html>"), this.iframeDoc.close(), this.iframeBody = this.iframeDoc.body, this.iframeHead = this.iframeDoc.head
          }, i.prototype._initEmptyBlocks = function() {
              this.emptySection = new B(this, B.SECTION), l.append(this.iframeBody, this.emptySection.el)
              ...
              this.emptySection.el.classList.toggle("fp-visible", t), this.iframeBody.classList.toggle("no-block", t), this.container.classList.toggle("fp-no-block", t), this.refreshIframeSize();
              var e = this.pageToolbar.ul ? this.pageToolbar.ul : t;
              l.setDownloadBtnsStatus(this, t, e)
          }, i.prototype.setView = function(t) {
              var e = this;
              this.activeView = t, this.body.classList.toggle("fp-add-view", this.activeView === p), this.body.classList.toggle("fp-full-view", this.activeView === r), this.iframeBody.classList.toggle("fp-add-view", this.activeView === p), this.iframeBody.classList.toggle("fp-full-view", this.activeView === r), this.designsPanel.setActiveBlock(), this.activeView === p ? this.designsPanel.show() : this.designsPanel.hide(), Array.from(this.iframeBody.querySelectorAll("[data-block-type]:not(header):not(footer)")).forEach(function(t) {
              ...
              this.dropPlaceholder || (this.dropPlaceholder = this.doc.createElement("DIV"), this.dropPlaceholder.classList.add("fp-drop-placeholder"), this.events.on(this.iframeDoc, "drop", function(t) {
                  ...
                  if (t.preventDefault(), o.activeView === p) {
                      var e = t.clientY,
                          i = l.offset(s).top,
                          n = l.outerHeight(s);
                      r && i < e ? l.after(s, o.dropPlaceholder) : a && i < e ? l.before(s, o.dropPlaceholder) : i + n / 2 < e ? l.after(s, o.dropPlaceholder) : l.before(s, o.dropPlaceholder), o.dropPlaceholder.isVisible = !0, o.refreshIframeSize()
                  }
                  ...
                  if (o.activeView === p) {
                      ...
                      o.body.classList.add("fp-dragging"), o.dragImage = o.doc.createElement("IMG"), o.dragImage.src = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mNkYPhfDwAChwGA60e6kgAAAABJRU5ErkJggg==", o.dragImage.style.position = "aboslute", l.append(o.body, o.dragImage), t.dataTransfer.setDragImage(o.dragImage, 0, 0), t.dataTransfer.setData("text/html", null), setTimeout(function() {
                          l.after(s, o.dropPlaceholder), o.dropPlaceholder.style.height = l.outerHeight(s, !0) + "px", o.dropPlaceholder.isVisible = !0, s.classList.add("fp-dragging")
                      }), o.draggingBlock = s
                  }
                  return !0
              })
              ...
              var i = this,
                  n = new a(this, t);
              if (Array.from(n.el.querySelectorAll("img")).forEach(function(t) {
              ...
              this.refreshBlocks(), this._makeBlockDraggable(n), this.events.on(n.el, "click", function(t) {
                  return t.target && "A" === t.target.tagName ? (t.preventDefault(), !1) : !t.target || "A" !== t.target.tagName || (t.preventDefault(), !1)
              ...
              return Array.from(this.iframeDoc.querySelectorAll("head > *:not([data-fp])")).map(function(t) {
                  return t.outerHTML
              }).join("\n  ")
          ...
          }, i.prototype.getJSON = function() {}, i.prototype.loadHTML = function() {}, i.prototype.loadJSON = function() {}, i
      }();
  return D.Events = A, D.Helpers = l, D.RegisterDesignBlock = c.Register, D.Button = f, D
});
