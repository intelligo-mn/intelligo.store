...
--
-- Host: localhost:3306
-- Generation Time: Nov 08, 2017 at 02:16 PM
...
--
-- Database: `triptomo_db`
--
CREATE DATABASE IF NOT EXISTS `triptomo_db` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `triptomo_db`;
